...
namespace Telstra.Messaging.Model
{
    ...
    /// SendMmsRequest
    /// </summary>
    [DataContract(Name = "SendMmsRequest")]
    public partial class SendMmsRequest : IEquatable<SendMmsRequest>, IValidatableObject
    {
        ...
        public SendMmsRequest(string from = default(string), string to = default(string), string subject = default(string), bool replyRequest = default(bool), string notifyURL = default(string), List<MMSContent> mMSContent = default(List<MMSContent>))
        {
            // to ensure "from" is required (not null)
            if (from == null)
            {
                throw new ArgumentNullException("from is a required property for SendMmsRequest and cannot be null");
            }
            this.From = from;
            // to ensure "to" is required (not null)
            if (to == null)
            {
                throw new ArgumentNullException("to is a required property for SendMmsRequest and cannot be null");
            }
            this.To = to;
            // to ensure "subject" is required (not null)
            if (subject == null)
            {
                throw new ArgumentNullException("subject is a required property for SendMmsRequest and cannot be null");
            }
            ...
            if (mMSContent == null)
            {
                throw new ArgumentNullException("mMSContent is a required property for SendMmsRequest and cannot be null");
            }
        ...
        [DataMember(Name = "replyRequest", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "MMSContent", IsRequired = true, EmitDefaultValue = true)]
