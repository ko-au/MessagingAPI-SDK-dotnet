...
namespace Telstra.Messaging.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProvisionNumberRequest")]
    public partial class ProvisionNumberRequest : IEquatable<ProvisionNumberRequest>, IValidatableObject
    {
        ...
        /// <param name="notifyURL">A notification URL that will be POSTed to whenever a new message (e.g. a reply to a message sent) arrives at this destination address.  If this is not provided then you can use the Get /sms or /mms API to poll for reply messages. *Please note that the notification URLs and the Get /sms or /mms call are exclusive. If a notification URL has been set then the GET call will not provide any useful information.* .</param>
        ...
        /// </summary>
        /// <value>A notification URL that will be POSTed to whenever a new message (e.g. a reply to a message sent) arrives at this destination address.  If this is not provided then you can use the Get /sms or /mms API to poll for reply messages. *Please note that the notification URLs and the Get /sms or /mms call are exclusive. If a notification URL has been set then the GET call will not provide any useful information.* </value>
        /// <example>&quot;http://example.com/callback&quot;</example>
