...
namespace Telstra.Messaging.Model
{
    ...
    public partial class MMSContent : IEquatable<MMSContent>, IValidatableObject
    {
        ...
        public MMSContent(string type = default(string), string filename = default(string), string payload = default(string))
        {
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for MMSContent and cannot be null");
            }
            this.Type = type;
            // to ensure "filename" is required (not null)
            if (filename == null)
            {
                throw new ArgumentNullException("filename is a required property for MMSContent and cannot be null");
            }
            this.Filename = filename;
            // to ensure "payload" is required (not null)
            if (payload == null)
            {
                throw new ArgumentNullException("payload is a required property for MMSContent and cannot be null");
            }
