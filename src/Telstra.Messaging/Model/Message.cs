...
namespace Telstra.Messaging.Model
{
    ...
    public partial class Message : IEquatable<Message>, IValidatableObject
    {
        ...
        public Message(string to = default(string), string deliveryStatus = default(string), string messageId = default(string), string messageStatusURL = default(string))
        {
            ...
            {
                throw new ArgumentNullException("deliveryStatus is a required property for Message and cannot be null");
            }
            this.DeliveryStatus = deliveryStatus;
            // to ensure "messageId" is required (not null)
            if (messageId == null)
            {
                throw new ArgumentNullException("messageId is a required property for Message and cannot be null");
            }
        ...
        /// <example>&quot;MessageWaiting&quot;</example>
        [DataMember(Name = "deliveryStatus", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// <example>&quot;d997474900097a1f0000000008d7e18102cc0901-1261412345678&quot;</example>
        ...
        /// <example>&quot;https://tapi.telstra.com/v2/messages/sms/d997474900097a1f0000000008d7e18102cc0901-1261412345678/status&quot;</example>
